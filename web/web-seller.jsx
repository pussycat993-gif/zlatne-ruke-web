  ...
  return (
    <Page footer={false}>
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', minHeight: 'calc(100vh - 200px)' }}>
        {/* Sidebar */}
        <aside style={{ background: 'white', borderRight: '1px solid var(--zr-border-soft)', padding: '32px 18px' }}>
...
function Step3() {
  return (
    <div>
      ...
      <div style={{ marginTop: 20, padding: 16, background: 'var(--zr-cream)', borderRadius: 12 }}>
        <h4 style={{ fontSize: 13, marginBottom: 10 }}>Zlatne Ruke provizija</h4>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, marginBottom: 4, color: 'var(--zr-gray)' }}><span>Provizija (8%)</span><span>−384 RSD</span></div>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 14, fontWeight: 700, color: 'var(--zr-pink-dark)', borderTop: '1px solid var(--zr-border-soft)', paddingTop: 8, marginTop: 8 }}><span>Tvoj prihod po prodaji</span><span>4.416 RSD</span></div>
      </div>
    </div>
  );
}
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
        {[
          ...
          <label key={o.id} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 14, borderRadius: 12, background: 'white', border: '1.5px solid var(--zr-border)', cursor: 'pointer' }}>
