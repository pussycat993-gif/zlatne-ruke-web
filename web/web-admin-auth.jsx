...
function AdminPanel() {
  ...
  return (
    <Page footer={false}>
      <div style={{ background: 'var(--zr-pink-dark)', color: 'white', padding: '14px 0', fontSize: 12, letterSpacing: '0.08em', textTransform: 'uppercase', fontFamily: 'var(--zr-font-mono)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', minHeight: 'calc(100vh - 200px)' }}>
        ...
        <main style={{ padding: '32px 40px', background: '#FAF6F0' }}>
...
function BecomeSeller() {
  return (
    <Page>
        ...
        <div className="zw-container" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ marginTop: 24, fontSize: 17, color: 'var(--zr-gray)', maxWidth: 460, lineHeight: 1.6 }}>
              Otvori radnju za 10 minuta. Prodaj na celu Srbiju. Mi se brinemo o sajtu, plaćanjima, dostavi i marketingu — ti pleti, mesi, kuj. Provizija samo 8% po prodaji.
            </p>
            ...
            <div style={{ marginTop: 32, display: 'flex', gap: 32 }}>
              ...
              <div><div style={{ fontSize: 28, fontWeight: 700, color: 'var(--zr-pink-dark)' }}>8%</div><div style={{ fontSize: 12, color: 'var(--zr-gray)', fontFamily: 'var(--zr-font-mono)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>provizija po prodaji</div></div>
            </div>
          </div>
      ...
      {/* Pricing */}
      <section className="zw-section-tight" style={{ background: 'white' }}>
        <div className="zw-container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <div className="zw-eyebrow">Provizija</div>
            <h2 style={{ fontSize: 48, marginTop: 14, lineHeight: 1.1 }}>Plaćaš samo kad <span className="zw-script" style={{ fontSize: 60, color: 'var(--zr-pink)' }}>prodaš.</span></h2>
            <p style={{ color: 'var(--zr-gray)', marginTop: 18, fontSize: 16, lineHeight: 1.7 }}>Bez startnih troškova, bez mesečnih pretplata, bez skrivenih taksi. Provizija je 8% po prodaji — uključuje hosting sajta, processiranje plaćanja, podršku za kupce i marketing.</p>
            <ul style={{ marginTop: 24, padding: 0, listStyle: 'none' }}>
              {['Bez startnih troškova', 'Bez mesečne pretplate', 'Plaćanje karticom & gotovinom', 'Tehnička podrška na srpskom', 'Marketing uključen (Google, Instagram)'].map(l => (
          ...
          <div className="zw-card" style={{ padding: 40, background: 'linear-gradient(135deg, var(--zr-pink-light), var(--zr-cream))' }}>
            ...
            <div style={{ marginTop: 14 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 0', fontSize: 15, color: 'var(--zr-gray)' }}><span>Zlatne Ruke (8%)</span><span>−384 RSD</span></div>
              <div className="zw-divider" />
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '14px 0', fontSize: 18, fontWeight: 700, color: 'var(--zr-pink-dark)' }}><span>Tvoj prihod</span><span>4.416 RSD</span></div>
            </div>
            <div style={{ marginTop: 18, padding: 14, background: 'white', borderRadius: 12, fontSize: 12, color: 'var(--zr-gray)' }}>💡 Mila & Konac: prosečno 12 šalova mesečno × 4.416 = <strong style={{ color: 'var(--zr-pink-dark)' }}>52.992 RSD/mesec</strong></div>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section style={{ background: 'var(--zr-pink-dark)', color: 'white', padding: '80px 0', textAlign: 'center' }}>
        <div className="zw-container">
          ...
          <button className="zw-btn zw-btn-lg" style={{ marginTop: 32, background: 'white', color: 'var(--zr-pink-dark)' }} onClick={() => navigate('/register?as=seller')}>Krenimo — besplatno je →</button>
        </div>
      </section>
    </Page>
  );
