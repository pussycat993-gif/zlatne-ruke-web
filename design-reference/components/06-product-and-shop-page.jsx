        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 64, marginTop: 12, marginBottom: 64 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginTop: 32 }}>
              ...
              <button onClick={() => toggleFav(product.id)} style={{ width: 56, height: 56, borderRadius: 999, border: '1.5px solid var(--zr-border)', background: 'var(--zr-surface)', cursor: 'pointer', color: fav ? 'var(--zr-pink)' : 'var(--zr-gray)' }}>
  ...
  return (
    <Page>
      ...
      <div className="zw-container" style={{ position: 'relative', marginTop: -100 }}>
        {/* Shop header card */}
        <div style={{ background: 'var(--zr-surface)', borderRadius: 24, padding: 32, boxShadow: 'var(--zr-shadow)', display: 'grid', gridTemplateColumns: '120px 1fr auto', gap: 32, alignItems: 'center' }}>
